...
![SmartNews screenshot](./docs/screenshot.png)
<!-- Replace the line above with an actual screenshot once you add one to a /docs folder in your repo -->
...
To keep the project simple, interview-friendly, and easy to reason about end-to-end, it deliberately does not use: TypeScript, Next.js, Express, a database (MongoDB/PostgreSQL/Supabase/Firebase), user authentication, Tailwind, or Redux. All state that needs to persist lives in the browser's localStorage.
